  ...
  return (
    ...
    >
      <nav className="max-container mx-[0rem] min-w-full flex justify-between items-center transition-all">
        ...
        <ul
          className={`link-style1 top-0 max-lg:pl-15 lg:opacity-100 max-lg:visibility-hidden max-lg:border-2 max-lg:drop-shadow-xl max-sm:grid max-sm:place-content-center linear duration-100 max-sm:gap-4 max-lg:mb-13px
