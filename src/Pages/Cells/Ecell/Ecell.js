...
export default function Ecell() {
  return <CellProfile number="02" title="E-Cell" eyebrow="Enterprise begins with a question" image={ecell} logo="/logos/ecell.png"
    statement="A place to test ideas, develop instincts and make a thoughtful leap from campus projects to real ventures."
    modules={[{ title: 'Start small', text: 'Conversations, workshops and first experiments for students learning how value is created.' }, { title: 'Think commercially', text: 'Business challenges that sharpen research, communication, strategy and conviction.' }, { title: 'Build networks', text: 'A bridge between student founders, alumni, industry voices and potential collaborators.' }]}
